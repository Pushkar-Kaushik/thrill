 ...
 * Description:
 * ------------
 * Smarty template to display the 'Failure' page in the event of failure after some action is performed
 *
 * Author:
 * -------
 * -------
  ...
  <div class="container">
	...
	<div class="cont-right">
		...
		<!-- Heading Start -->
			...
			<div class="heading-middle-box"><img src="images/icon-user.jpg"/>&nbsp;&nbsp;Profile & Content Management</div>
			<b class='b4bh'></b>
			<b class='b3bh'></b>
			<font color="#0033FF"><b>UNSUCCESSFULL !!</b></font>
        </div>
	</div>
	<!-- Container Right End -->
