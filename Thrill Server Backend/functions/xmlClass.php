 ...
 * Description:
 * ------------
 * This file consists of a Class which helps in generating XML  
 *
 * Author:
 * -------
 * -------
...
class xmlClass extends SimpleXMLElement
{
	...
	public function _construct(string $xmlstr)
	{
		parent::_construct($xmlstr);
	}
	
	
	public function addChildKeyValue($key, $value)
	{
	...
	public function appendChildKey($key)
	{
	...
	public function addChildAttribute($key, $value)
	{
